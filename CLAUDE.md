...
V2.1 完了 (方向グループ規則の一般化 — 端点完全一致→順序整合度。V3 レビューで
判明したモデル欠陥の割り込み修正。規則は presentation.md R15 改訂注記、
検証は docs/verification/V2_1_direction_groups.md)。
**V3 (ビューア再構築 — 4部構成 UI、検証モード、色弱原則の徹底) 再開・進行中**。
