...
const DICT = {
  ...
  en: {
    ...
    sdn_title: "Service-day notes",
    sdn_windows: (a, b, c, d) => `Coverage: old ${a}–${b} / new ${c}–${d}`,
    ...
    sdn_changed: "Days whose service content changes",
