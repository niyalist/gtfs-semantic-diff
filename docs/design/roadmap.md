...
- **SD4: 運行日カレンダービュー** 【完了 2026-07-23
  (docs/verification/SD4_calendar_view.md)】 — 第1部に新旧の年間グリッド。
  セル = ▲?+ダイヤ区分1文字+◆? (記号第1チャネル)、期間の切れ目は太罫線+
  交互背景。桑名 (世代境界+祝日振替 ▲休)・PRT (メモリアルデー ▲休◆、
  7/4・9/7 ・◆)・亀山市 (年始全休「・」。春夏冬は T3 据え置きで ◆) で
  ドライラン確認。窓 550 日超 (国家規模) は省略。
