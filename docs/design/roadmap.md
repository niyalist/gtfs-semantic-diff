...
> 状態 (2026-07-07): **M0〜M7・W1・V1・V2・V2.1 完了。V3 (ビューア再構築) 再開。**
> V2.1 は V3 レビューで判明したモデル欠陥の割り込み修正
> (検証: docs/verification/V2_1_direction_groups.md。前橋玉村線型の大テーブル化など
> 見え方の最終確認は V3 レビューで継続)。
...
- **V4: 停留所の変化ページ** — D群イベントを停留所クラスタ単位に束ねた人向け章。
  ...
  相互リンクを目視確認。合成テスト。
  **第1イテレーション完了 (2026-07-07、docs/verification/V4_stop_changes.md)** —
  章・まとめ表示・専用地図・実フィード確認済み。相互リンクと Lev.3 改称注釈は
  レビューラウンドで継続。
