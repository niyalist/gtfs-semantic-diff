...
| mbta | 1356s | **300s** (4.5x) | >1800s (TO) → 1010s |

mbta の当初記録 (1677s、便対応 294s) は計測中の PC スリープ混入が判明し、
2026-07-23 に caffeinate 付きで再計測した値に訂正 (イベント数・explained は一致)。
...
- ルール段 (L2) が新たな支配項 (MBTA 616s)。RawDiff 1000万件超で非線形の疑い
