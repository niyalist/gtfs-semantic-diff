...
## 現行環境 (2026-07-07 デプロイ)

- アカウント: 948645358251 / リージョン: ap-northeast-1 / プロファイル:
  `AdministratorAccess-948645358251` (IAM Identity Center)
- 配信ドメイン: `d22mbbm5uatfcc.cloudfront.net` (Distribution: EYTCIY3LJP6UZ)
- バケット: `gtfssemdiffdelivery-results25575328-nvr2pk0jkbn1`
- 公開済み: 永井 `/r/nagai-unyu__Nagaibus__prev_2__prev_1.html`、
  地鉄 `/r/chitetsu__chitetsubus__prev_2__prev_1.html` (HTTP 200 確認済み)
- 教訓: プロファイルに region が無く bootstrap が us-east-1 へ向かった →
...
- 入口: `https://d22mbbm5uatfcc.cloudfront.net/` (入力 UI)。
